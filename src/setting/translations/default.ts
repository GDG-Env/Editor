...
export default {
  ...
  noLayerHint: "Select one feature layer, add it once, then choose all fields you want on that layer.",
  layerLabel: "Layer",
  chooseLayer: "Choose a feature layer",
  layerAlreadyAdded: "This layer is already configured below.",
